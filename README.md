...
2. **Расширение Dev Containers** для VS Code
3. Архитектура проекта в файле Arhitect.txt


### Правила по работе с курсовой
1. С master веткой не работаем, для своей задачи создаем ветку вней работает, потом только мерджим в master
2. Задачи в docs/Task
3. Обязательно введем документацию в папке docs
